...
#ifndef __BLACK_LIBRARY_CORE_DB_RESTDBSERVER_H__
#define __BLACK_LIBRARY_CORE_DB_RESTDBSERVER_H__
...
class RESTDBServer : public DBConnectionInterface
{
public:
    explicit RESTDBServer(const std::string &database_url, const std::string &db_version);
    ~RESTDBServer();
