...
black_library::BlackLibraryCLI *blacklibrary_cli;
...
int main(int argc, char* argv[])
{
    ...
    black_library::BlackLibraryCLI cli(opts.db_path, opts.storage_path);

    blacklibrary_cli = &cli;

    blacklibrary_cli->Run();
